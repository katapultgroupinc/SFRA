...
exports.calculate = function (basket) {
    ...
    HookMgr.callHook('dw.order.calculateTaxKatapult', 'calculateTax', basket);
...
exports.calculateTax = function(basket) {
    var isKatapult = basket.paymentInstruments.length && basket.paymentInstruments[0].paymentMethod === "KATAPULT" ? true : false;
    var basketCalculationHelpers = require('*/cartridge/scripts/helpers/basketCalculationHelpers');

    var taxes = basketCalculationHelpers.calculateTaxeskatapult(basket);
