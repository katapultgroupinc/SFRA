...
function cancelItem () {
    /*var orderTest = OrderMgr.getOrder("00001301");
    Transaction.wrap(function(){

            for(i in order.productLineItems){
            //Here goes a test in order to verify which line item has to be canceled.
            orderTest.productLineItems[i].externalLineItemStatus = "canceled";
            orderTest.productLineItems[i].custom.KAT_cancelItem = true;
        }
