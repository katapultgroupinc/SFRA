...
function getOrderLevelDiscountTotal(lineItemContainer) {
    ...
    function infoShop() {
        ...
        var modelOrder = {shipping:[],billing:{ billingAddress: {}},totals: {totalShippingCost: {}, orderLevelDiscountTotal: {}, shippingLevelDiscountTotal:{}}, priceTotal: 0};
        var shipmentsInt = currentBasket.shipments.iterator();
        while (shipmentsInt.hasNext()) {
            var shipmentLine = shipmentsInt.next();
            modelOrder.shipping.push({shippingAddress: {
